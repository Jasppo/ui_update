...
appSidebar_home <- tagList(
  div(id = "sidebar_home",
      ...
      tags$ul(style = "list-style-type: none; padding-left: 0;",
              ...
              hr(style = "border: 1px solid #ddd; margin-top: 5px; margin-bottom: 5px;"),
              tags$li(
                tags$a(href = "https://github.com/your-repo", target = "_blank",
              ...
              hr(style = "border: 1px solid #ddd; margin-top: 5px; margin-bottom: 5px;"),
              tags$li(
                tags$a(href = "https://policyplanning.ca.gov", target = "_blank",
...
make_nav_panel <- function(myTitle, myValue, myID1, myID2, input1, input2, outputType = plotOutput) {
  nav_panel(title = myTitle, 
            ...
            layout_column_wrap(
              ...
              fluidRow(style = "border: 2px solid #7157db;",
                       layout_column_wrap(
                         width = NULL,
...
featuredStory <- function(
  ...
  as_fill_carrier(
    a(href = myURL, target = "_blank", style = "text-decoration: none; color: unset;",
      card(
        card_body(img(src = paste0("Featured Stories/", myImage)), padding = "20px", height = "50%"),
...
inputYear <- function(id = NULL, label = "Year:", choices, selected) {
  selectInput(id, label = label, choices = choices, selected = selected)
}

inputLHJ <- function(id = NULL) {
  selectInput(id, "County/State:", choices = c("Alameda", "CALIFORNIA"), selected = "CALIFORNIA")
}

inputMeasure <- function(id = NULL, label = "Measure:", choices, selected = "aRate") {
  selectInput(id, label = label, choices = choices, selected = selected)
}
  ...
  tagList(
    ...
    div(class = "hero-wrapper",
        div(class = "hero-image",
            ...
            ## Header -----------------------------------------------------------------------------------------------
            div(class = "hero-text",
                h1("California Community Burden of Disease Engine", style = "font-size:50px"),
            ...
            card(
              ...
              navset_pill_list(
                ...
                make_nav_panel(myTitle = "MAPS", myValue = "anatomy_mapsTab", myID1 = NS(id, "anatomy_info_mapsTab"), myID2 = NS(id, "anatomy_plot_maps"), 
                               input1 = inputYear(id = NS(id, "myYear_maps"), label = NULL, choices = 2000:2021, selected = 2021), 
                               input2 = inputMeasure(id = NS(id, "myMeasure_maps"), label = NULL, choices = choices$deathMeasuresAll, selected = "aRate"),  
                ...
                make_nav_panel(myTitle = "TRENDS", myValue = "anatomy_trendsTab", myID1 = NS(id, "anatomy_info_trendsTab"), myID2 = NS(id, "anatomy_plot_trends"), 
                               input1 = inputLHJ(id = NS(id, "myLHJ_trends")), 
                               input2 = inputMeasure(id = NS(id, "myMeasure_trends"), label = "Measure:", choices = choices$deathMeasuresAll, selected = "aRate"),  
                ...
                make_nav_panel(myTitle = "RANK BY CAUSE", myValue = "anatomy_rankByCauseTab", myID1 = NS(id, "anatomy_info_rankByCauseTab"), myID2 = NS(id, "anatomy_plot_rankByCause"), 
                               input1 = inputYear(id = NS(id, "myYear_rankByCause"), label = "Year:", choices = 2000:2021, selected = 2021), 
                               input2 = inputLHJ(id = NS(id, "myLHJ_rankByCause")),  
                               outputType = plotOutput),
                ...
                make_nav_panel(myTitle = "RANK BY GEOGRAPHY", myValue = "anatomy_rankByGeoTab", myID1 = NS(id, "anatomy_info_rankByGeographyTab"), myID2 = NS(id, "anatomy_plot_rankByGeo"), 
                               input1 = inputYear(id = NS(id, "myYear_rankByGeo"), label = "Year:", choices = 2000:2021, selected = 2021), 
                               input2 = inputLHJ(id = NS(id, "myLHJ_rankByGeo")),  
  ...
  div(class = "info-row", 
      HTML(
        "<div class='section-container'>
                    <h1 class='section-title'>WHAT IS THE CCB?</h1>
                    </div>"
      ),
      br(),
...
ui_featured <- tagList(
  div(class = "featured-row", 
      HTML("<div class='section-container'>, 
                       <h1 class='section-title'>FEATURED PUBLICATIONS</h1>
                       </div>
                       "), 
      br(),
      layout_column_wrap(
