ccbMap <- function(myLHJ = "Alameda", 
  ...
  if (myGeo == "County") {
    ...
    datCounty <- lazy_load(file.path("myData", constants$dataType, "datCounty.RDS"))
    ...
    datComm <- lazy_load(file.path("myData", constants$dataType, "datComm.RDS"))
    ...
    datTract <- lazy_load(file.path("myData", constants$dataType, "datTract.RDS"))
