disparity <- function(myLHJ="CALIFORNIA",
  ...
  if(myCompare == "Highest Rate") {
    ...
    raceTest <- lazy_load(file.path("myData/", constants$dataType, "disparity_raceHigh.RDS")) %>% 
      filter(raceCode != "Multi")
    
  } else {
    
    raceTest <- lazy_load(file.path("myData/", constants$dataType, "disparity_raceLow.RDS")) %>% 
      filter(raceCode != "Multi")
  ...
  if(myCompare == "Highest Rate") {
    ageTest <- lazy_load(file.path("myData/", constants$dataType, "disparity_ageHigh.RDS"))
  } else {
    ageTest <- lazy_load(file.path("myData/", constants$dataType, "disparity_ageLow.RDS"))
  }
  ...
  if(myCompare == "Highest Rate") {
    sexTest <- lazy_load(file.path("myData/", constants$dataType, "disparity_sexHigh.RDS"))
  } else {
    sexTest <- lazy_load(file.path("myData/", constants$dataType, "disparity_sexLow.RDS"))
  }
